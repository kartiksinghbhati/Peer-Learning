...
const StudentAssignmentPage2 = () => {
    ...
    const { user, userData, assignment, role } = useContext(AuthContext);
            ...
            :   <div className="dashboard">
                    <div className="contain">
                        {  role === "student" ?
                                 ...
                                 : <StudentAssignmentView2 assg={assignment1} activities={activities} marks={marks} youractivities={youractivities}/>
                            : null
                        }
                    </div>
                </div>
