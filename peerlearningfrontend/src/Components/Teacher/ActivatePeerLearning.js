...
import styles from "./ActivatePeerLearning.module.css";

const ActivatePeerLearning = (props) => {
  ...
  return (
      <div>
        <button className={styles.btn2} onClick={OnClickOpen}>Activate Peer Learning </button>
...
export default ActivatePeerLearning
